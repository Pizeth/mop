<div class="carousel fade padding-0" data-ride="carousel" id="mySecondCarousel">
    <div class="carousel-inner">
        <div class="item active">
            <div class="img-slide relative">
                <div class="slide-img-wrap"><img src=
                "https://www.mptc.gov.kh/storage/posts/March2019/LE0l9rHrffay2glhzqus.jpg"></div>
                <div class="carousel-caption">
                    <div class="carousel-caption-inner">
                        <a href="https://www.mptc.gov.kh/article/3761">
                        <h4 class="slide-title">​ឯកឧត្តម​រដ្ឋមន្ត្រី​ ​ត្រាំ​ អុី​វ​តឹក​
                        ​អញ្ជើញ​ចូលរួម​ក្នុង​មហាសន្និបាត​ទូរស័ព្ទ​ចល័ត​ពិភពលោក​ឆ្នាំ​២​០​១​៩​
                        ​និង​កិច្ចប្រជុំ​ពាក់ព័ន្ធ​ ​នៅ​ប្រទេស​អេស្ប៉ា​ញ​</h4></a>
                    </div>
                </div>
            </div>
        </div>
        <div class="item">
            <div class="img-slide relative">
                <div class="slide-img-wrap"><img src=
                "https://www.mptc.gov.kh/storage/posts/February2019/NFKMMJS4TsqespwEDrc5.jpg"></div>
                <div class="carousel-caption">
                    <div class="carousel-caption-inner">
    ...
    <ol class="carousel-indicators">
        <li class="active" data-slide-to="0" data-target="#mySecondCarousel"></li>
        <li class="" data-slide-to="1" data-target="#mySecondCarousel"></li>
        <li class="" data-slide-to="2" data-target="#mySecondCarousel"></li>
        <li class="" data-slide-to="3" data-target="#mySecondCarousel"></li>
        <li class="" data-slide-to="4" data-target="#mySecondCarousel"></li>
    </ol>
</div>