						...
						<div class="row list-wrap">
							...
							<div class="col-6">
								<div class="panel fix-height" style="box-shadow: none;">
									<div class="panel-heading">
										<?php
											$news = new WP_Query('category_name="News" &posts_per_page=15');
											$id = $news->get_queried_object_id(); 
											$count = $news->found_posts;
											$post_per_page = $news->query_vars['posts_per_page'];
											$cat_link = get_category_link($id);
										?>
										<h3 class="panel-title block-title">
											<a class="hvr-underline-from-center" href="<?php echo $cat_link; ?> ">
									...
									<div class="panel-body">
													...
													<div class="col-8 no-pad">
														<h3 class="entry-title">
															<a href="<?php the_permalink($post->ID); ?>" 
																...
																<?php echo get_post_label(get_post_time(), 'ទាន់ហេតុការណ៍!', true); ?>
										...
										<hr <?php echo $count <= $post_per_page ? 'hidden' : ''; ?>>
							...
							<div class="col-6">
								<div class="panel fix-height" style="box-shadow: none;">
									<div class="panel-heading">
										<?php
											$announcement = new WP_Query('category_name="Announcement" &posts_per_page=15');
											$id = $announcement->get_queried_object_id(); 
											$count = $announcement->found_posts;
											$cat_link = get_category_link($id);
											$post_per_page = $announcement->query_vars['posts_per_page'];
										?>
										<h3 class="panel-title block-title">
											<a class="hvr-underline-from-center" href="<?php echo $cat_link; ?> ">
											...
											<?php if ($announcement->have_posts()) : while ($announcement->have_posts()) : $announcement->the_post(); ?>
												<li class="list-group-item">
													<a class="title" href="<?php the_permalink($post->ID); ?>">
														...
														<?php echo get_post_label(get_post_time(), 'ថ្មី!'); ?>
							...
							<div class="col-12">
								<div class="panel fix-height" style="box-shadow: none;">
									<div class="panel-heading">
										...
										<h3 class="panel-title block-title">
											<span><i class="far fa-newspaper"></i> សម្រង់ព័ត៌មាន និងព្រឹត្តិការណ៍សំខាន់ៗប្រចាំខែ</span>
										</h3>
										<div class="space-2"></div>
									</div>
									<div class="panel-body">
										...
										?>
											<a class="screen flash" href="<?php the_permalink(); ?>">
													<h1>
													<?php 
													...
													<h3 class="date">
														<i class=" far fa-clock fa-fw"></i> <?php echo dynamictime(); //the_time('D j F Y'); ?>
													</h3>
													<?php the_post_thumbnail('post-thumbnail', array('class'  => 'img-thumbnail')); ?>
													<div class="content">
														<h2><?php echo shorten_title(get_the_title(), 70); ?></h2>
														<p><?php echo shorten_title(get_the_excerpt(), 150); ?></p>
													</div>
											</a>
										<?php 
											endwhile; endif; 
							...
							<!-- End of Featured Content Section -->
						</div>
					</div>
					<!-- Widget -->
					<?php get_sidebar(); ?>
