...
function themonic_theme_customizer( $wp_customize ) {
     $wp_customize->add_section( 'mop_logo_section' , array(
    'title'       => __( 'Logo', 'iconic-one' ),
    'priority'    => 30,
    'description' => 'Upload a logo to replace the default site name and description in the header',
	) );
	$wp_customize->add_setting( 'mop_logo' , array('default' => '', 'sanitize_callback' => 'esc_url_raw',));
	$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'mop_logo', array(
		'label'    => __( 'Logo', 'iconic-one' ),
		'section'  => 'mop_logo_section',
		'settings' => 'mop_logo',
	) ) );
	...
	$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'minister_img', array(
		'label'    => __( 'Image', 'iconic-one' ),
		'section'  => 'mop_minister_section',
		'settings' => 'minister_img',
	) ) );
