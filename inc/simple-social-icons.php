...
class Simple_Social_Icons_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$this->profiles = apply_filters( 'simple_social_default_profiles', array(
			'artstation' => array(
				'label'   => __( 'Artstation URI', 'simple-social-icons' ),
				'pattern' => $this->get_icon_markup( 'fab fa-artstation', __( 'fa-artstation', 'simple-social-icons' ) ),
			),
			'500px' => array(
				'label'   => __( '500px URI', 'simple-social-icons' ),
				'pattern' => $this->get_icon_markup( 'fab fa-500px', __( 'fa-500px', 'simple-social-icons' ) ),
			),
			'behance' => array(
				'label'   => __( 'Behance URI', 'simple-social-icons' ),
				'pattern' => $this->get_icon_markup( 'fab fa-behance', __( 'behance', 'simple-social-icons' ) ),
			),
			'bitbucket' => array(
				'label'   => __( 'Bitbucket URI', 'simple-social-icons' ),
				'pattern' => $this->get_icon_markup( 'fab fa-bitbucket', __( 'bitbucket', 'simple-social-icons' ) ),
			),
			'codepen' => array(
				'label'   => __( 'CodePen URI', 'simple-social-icons' ),
				'pattern' => $this->get_icon_markup( 'fab fa-codepen', __( 'codepen', 'simple-social-icons' ) ),
			),
			'deviantart' => array(
				'label'   => __( 'Deviantart URI', 'simple-social-icons' ),
				'pattern' => $this->get_icon_markup( 'fab fa-deviantart', __( 'deviantart', 'simple-social-icons' ) ),
			),
			'discord' => array(
				'label'   => __( 'Discord URI', 'simple-social-icons' ),
				'pattern' => $this->get_icon_markup( 'fab fa-discord', __( 'discord', 'simple-social-icons' ) ),
			),
			'docker' => array(
				'label'   => __( 'Docker URI', 'simple-social-icons' ),
				'pattern' => $this->get_icon_markup( 'fab fa-docker', __( 'docker', 'simple-social-icons' ) ),
			),
			'dribbble' => array(
				'label'   => __( 'Dribbble URI', 'simple-social-icons' ),
				'pattern' => $this->get_icon_markup( 'fab fa-dribbble', __( 'dribbble', 'simple-social-icons' ) ),
			),
			'ebay' => array(
				'label'   => __( 'Ebay URI', 'simple-social-icons' ),
				'pattern' => $this->get_icon_markup( 'fab fa-ebay', __( 'ebay', 'simple-social-icons' ) ),
			),
			'email' => array(
				'label'   => __( 'Email URI', 'simple-social-icons' ),
				'pattern' => $this->get_icon_markup( 'far fa-envelope', __( 'email', 'simple-social-icons' ) ),
			),
			'facebook' => array(
				'label'   => __( 'Facebook URI', 'simple-social-icons' ),
				'pattern' => $this->get_icon_markup( 'fab fa-facebook-f', __( 'facebook', 'simple-social-icons' ) ),
			),
			'flickr' => array(
				'label'   => __( 'Flickr URI', 'simple-social-icons' ),
				'pattern' => $this->get_icon_markup( 'fab fa-flickr', __( 'flickr', 'simple-social-icons' ) ),
			),
			'flipboard' => array(
				'label'   => __( 'Flipboard URI', 'simple-social-icons' ),
				'pattern' => $this->get_icon_markup( 'fab fa-flipboard', __( 'flipboard', 'simple-social-icons' ) ),
			),
			'getpocket' => array(
				'label'   => __( 'Getpocket URI', 'simple-social-icons' ),
				'pattern' => $this->get_icon_markup( 'fab fa-get-pocket', __( 'getpocket', 'simple-social-icons' ) ),
			),
			'github' => array(
				'label'   => __( 'GitHub URI', 'simple-social-icons' ),
				'pattern' => $this->get_icon_markup( 'fab fa-github', __( 'github', 'simple-social-icons' ) ),
			),
			'gitlab' => array(
				'label'   => __( 'Gitlab URI', 'simple-social-icons' ),
				'pattern' => $this->get_icon_markup( 'fab fa-gitlab', __( 'gitlab', 'simple-social-icons' ) ),
			),
			'jsfiddle' => array(
				'label'   => __( 'jsfiddle URI', 'simple-social-icons' ),
				'pattern' => $this->get_icon_markup( 'fab fa-jsfiddle', __( 'jsfiddle', 'simple-social-icons' ) ),
			),
			'instagram' => array(
				'label'   => __( 'Instagram URI', 'simple-social-icons' ),
				'pattern' => $this->get_icon_markup( 'fab fa-instagram', __( 'instagram', 'simple-social-icons' ) ),
			),
			'kickstarter' => array(
				'label'   => __( 'Kickstarter URI', 'simple-social-icons' ),
				'pattern' => $this->get_icon_markup( 'fab fa-kickstarter-k', __( 'kickstarter', 'simple-social-icons' ) ),
			),
			'linkedin' => array(
				'label'   => __( 'Linkedin URI', 'simple-social-icons' ),
				'pattern' => $this->get_icon_markup( 'fab fa-linkedin-in', __( 'linkedin', 'simple-social-icons' ) ),
			),
			'medium' => array(
				'label'   => __( 'Medium URI', 'simple-social-icons' ),
				'pattern' => $this->get_icon_markup( 'fab fa-medium-m', __( 'medium', 'simple-social-icons' ) ),
			),
			'messenger' => array(
				'label'   => __( 'Messenger URI', 'simple-social-icons' ),
				'pattern' => $this->get_icon_markup( 'fab fa-facebook-messenger', __( 'messenger', 'simple-social-icons' ) ),
			),
			'microsoft' => array(
				'label'   => __( 'Microsoft URI', 'simple-social-icons' ),
				'pattern' => $this->get_icon_markup( 'fab fa-microsoft', __( 'microsoft', 'simple-social-icons' ) ),
			),
			'mix' => array(
				'label'   => __( 'Mix URI', 'simple-social-icons' ),
				'pattern' => $this->get_icon_markup( 'fab fa-mix', __( 'mix', 'simple-social-icons' ) ),
			),
			'periscope' => array(
				'label'   => __( 'Periscope URI', 'simple-social-icons' ),
				'pattern' => $this->get_icon_markup( 'fab fa-periscope', __( 'periscope', 'simple-social-icons' ) ),
			),
			'phone' => array(
				'label'   => __( 'Phone URI', 'simple-social-icons' ),
				'pattern' => $this->get_icon_markup( 'fas fa-phone-alt', __( 'phone', 'simple-social-icons' ) ),
			),
			'pinterest' => array(
				'label'   => __( 'Pinterest URI', 'simple-social-icons' ),
				'pattern' => $this->get_icon_markup( 'fab fa-pinterest', __( 'pinterest', 'simple-social-icons' ) ),
			),
			'reddit' => array(
				'label'   => __( 'Reddit URI', 'simple-social-icons' ),
				'pattern' => $this->get_icon_markup( 'fab fa-reddit-alien', __( 'reddit', 'simple-social-icons' ) ),
			),
			'sketcfab' => array(
				'label'   => __( 'Sketcfab URI', 'simple-social-icons' ),
				'pattern' => $this->get_icon_markup( 'fas fa-dice-d6', __( 'sketchfab', 'simple-social-icons' ) ),
			),
			'skype' => array(
				'label'   => __( 'Skype URI', 'simple-social-icons' ),
				'pattern' => $this->get_icon_markup( 'fab fa-skype', __( 'skype', 'simple-social-icons' ) ),
			),
			'slack' => array(
				'label'   => __( 'Slack URI', 'simple-social-icons' ),
				'pattern' => $this->get_icon_markup( 'fab fa-slack', __( 'slack', 'simple-social-icons' ) ),
			),
			'spotify' => array(
				'label'   => __( 'Spotify URI', 'simple-social-icons' ),
				'pattern' => $this->get_icon_markup( 'fab fa-spotify', __( 'spotify', 'simple-social-icons' ) ),
			),
			'soundcloud' => array(
				'label'   => __( 'Soundcloud URI', 'simple-social-icons' ),
				'pattern' => $this->get_icon_markup( 'fab fa-soundcloud', __( 'soundcloud', 'simple-social-icons' ) ),
			),
			'stackoverflow' => array(
				'label'   => __( 'Stack Overflow URI', 'simple-social-icons' ),
				'pattern' => $this->get_icon_markup( 'fab fa-stack-overflow', __( 'stackoverflow', 'simple-social-icons' ) ),
			),
			'steam' => array(
				'label'   => __( 'Steam URI', 'simple-social-icons' ),
				'pattern' => $this->get_icon_markup( 'fab fa-steam', __( 'steam', 'simple-social-icons' ) ),
			),
			'telegram' => array(
				'label'   => __( 'Telegram URI', 'simple-social-icons' ),
				'pattern' => $this->get_icon_markup( 'fab fa-telegram-plane', __( 'telegram', 'simple-social-icons' ) ),
			),
			'trello' => array(
				'label'   => __( 'Trello URI', 'simple-social-icons' ),
				'pattern' => $this->get_icon_markup( 'fab fa-trello', __( 'trello', 'simple-social-icons' ) ),
			),
			'tumblr' => array(
				'label'   => __( 'Tumblr URI', 'simple-social-icons' ),
				'pattern' => $this->get_icon_markup( 'fab fa-tumblr', __( 'tumblr', 'simple-social-icons' ) ),
			),
			'twitch' => array(
				'label'   => __( 'Twitch URI', 'simple-social-icons' ),
				'pattern' => $this->get_icon_markup( 'fab fa-twitch', __( 'twitch', 'simple-social-icons' ) ),
			),
			'twitter' => array(
				'label'   => __( 'Twitter URI', 'simple-social-icons' ),
				'pattern' => $this->get_icon_markup( 'fab fa-twitter', __( 'twitter', 'simple-social-icons' ) ),
			),
			'vimeo' => array(
				'label'   => __( 'Vimeo URI', 'simple-social-icons' ),
				'pattern' => $this->get_icon_markup( 'fab fa-vimeo-v', __( 'vimeo', 'simple-social-icons' ) ),
			),
			'whatsapp' => array(
				'label'   => __( 'Whatsapp URI', 'simple-social-icons' ),
				'pattern' => $this->get_icon_markup( 'fab fa-whatsapp', __( 'whatsapp', 'simple-social-icons' ) ),
			),
			// 'wordpress' => array(
			// 	'label'   => __( 'WordPress URI', 'simple-social-icons' ),
			// 	'pattern' => $this->get_icon_markup( 'fab fa-wordpress', __( 'wordpress', 'simple-social-icons' ) ),
			// ),
			'xing' => array(
				'label'   => __( 'Xing URI', 'simple-social-icons' ),
				'pattern' => $this->get_icon_markup( 'fab fa-xing', __( 'xing', 'simple-social-icons' ) ),
			),
			'youtube' => array(
				'label'   => __( 'YouTube URI', 'simple-social-icons' ),
				'pattern' => $this->get_icon_markup( 'fab fa-youtube', __( 'youtube', 'simple-social-icons' ) ),
			),
		) );
		...
		<?php if ( ! $this->disable_css_output ) { ?>
			...
			<p>
				...
				<select id="<?php echo $this->get_field_id( 'alignment' ); ?>" name="<?php echo $this->get_field_name( 'alignment' ); ?>">
					<option value="left" <?php selected( 'left', $instance['alignment'] ) ?>><?php _e( 'Align Left', 'simple-social-icons' ); ?></option>
					<option value="center" <?php selected( 'center', $instance['alignment'] ) ?>><?php _e( 'Align Center', 'simple-social-icons' ); ?></option>
					<option value="right" <?php selected( 'right', $instance['alignment'] ) ?>><?php _e( 'Align Right', 'simple-social-icons' ); ?></option>
				</select>
			</p>
	...
	function widget( $args, $instance ) {
		...
		echo $before_widget;
			...
			if ( $output ) {
				...
				printf( '<nav class="social-button"><ul class="%s">%s</ul></nav>', $instance['alignment'], $output );
			}
	...
	function enqueue_css() {
		 ...
		 */
		// $cssfile = apply_filters( 'simple_social_default_stylesheet', trailingslashit(get_template_directory_uri()) . '/inc/css/style.css' );
		...
		if ( ! function_exists( 'is_amp_endpoint' ) || ( function_exists( 'is_amp_endpoint' ) && ! is_amp_endpoint() ) ) {
			wp_enqueue_script('svg-x-use', trailingslashit(get_template_directory_uri()) . '/inc/svgxuse.js', array(), '1.1.21' );
		}
	}
	...
	function get_icon_markup( $icon, $label ) {
		...
		// $markup .= '<use xlink:href="' . esc_url(trailingslashit(get_template_directory_uri()) . '/inc/symbol-defs.svg#social-' . $icon ) . '"></use>';
		// $markup .= '</svg></a></li>';

		$markup = '<li class="' . $label . '"><a href="%s" %s><i class="' . $icon . '"></i></a></li>';
		// $markup .= '<svg role="img" class="social-' . $icon . '" aria-labelledby="social-' . $icon . '-{WIDGET_INSTANCE_ID}">';
		// $markup .= '<title id="social-' . $icon . '-{WIDGET_INSTANCE_ID}' . '">' . $label . '</title>';
		// $markup .= '<use xlink:href="' . esc_url(trailingslashit(get_template_directory_uri()) . '/inc/symbol-defs.svg#social-' . $icon ) . '"></use>';
		// $markup .= '</svg></a></li>';
